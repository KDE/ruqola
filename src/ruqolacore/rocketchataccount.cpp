...
void RocketChatAccount::createDiscussion(const QString &parentRoomId, const QString &discussionName)
{
    restApi()->createDiscussion(parentRoomId, discussionName, QString() /*TODO*/);
}
