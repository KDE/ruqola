...
void AcceptSuggestedGroupKeyJobTest::shouldHaveDefaultValue()
{
...
void AcceptSuggestedGroupKeyJobTest::shouldGenerateRequest()
{
    ResetOwnE2eKeyJob job;
...
void AcceptSuggestedGroupKeyJobTest::shouldNotStarting()
{
    ResetOwnE2eKeyJob job;
...
#include "moc_acceptsuggestedgroupkeyjobtest.cpp"
