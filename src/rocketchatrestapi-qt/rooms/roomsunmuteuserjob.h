...
Q_DECLARE_TYPEINFO(RocketChatRestApi::RoomsUnmuteUserJob::CleanHistoryInfo, Q_RELOCATABLE_TYPE);
LIBROCKETCHATRESTAPI_QT_EXPORT QDebug operator<<(QDebug d, const RocketChatRestApi::RoomsUnmuteUserJob::CleanHistoryInfo &t);
