...
{
class LIBROCKETCHATRESTAPI_QT5_TESTS_EXPORT CreateTeamJob : public RestApiAbstractJob
{
    Q_OBJECT
public:
    explicit CreateTeamJob(QObject *parent = nullptr);
    ~CreateTeamJob() override;
