...
class LIBROCKETCHATRESTAPI_QT5_TESTS_EXPORT ChannelGetCountersJob : public RestApiAbstractJob
{
    Q_OBJECT
public:
...
Q_SIGNALS:
    void channelGetCountersDone(const QJsonObject &obj, const QString &roomId);
