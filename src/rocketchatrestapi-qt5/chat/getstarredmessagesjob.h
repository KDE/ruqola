...
#ifndef GETSTARREDMESSAGESJOB_H
#define GETSTARREDMESSAGESJOB_H
...
class LIBROCKETCHATRESTAPI_QT5_TESTS_EXPORT GetStarredMessagesJob : public RestApiAbstractJob
{
    Q_OBJECT
public:
