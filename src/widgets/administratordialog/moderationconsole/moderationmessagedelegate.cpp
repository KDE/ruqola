...
ModerationMessageDelegate::~ModerationMessageDelegate() = default;
...
void ModerationMessageDelegate::drawAccountRoomInfo(QPainter *painter, const QModelIndex &index, const QStyleOptionViewItem &option) const
{
...
void ModerationMessageDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    painter->save();
...
QSize ModerationMessageDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index) const
{
...
ModerationMessageDelegate::Layout ModerationMessageDelegate::doLayout(const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    ModerationMessageDelegate::Layout layout;
...
bool ModerationMessageDelegate::helpEvent(QHelpEvent *helpEvent, QAbstractItemView *view, const QStyleOptionViewItem &option, const QModelIndex &index)
{
...
QPoint ModerationMessageDelegate::adaptMousePosition(const QPoint &pos, QRect textRect, const QStyleOptionViewItem &option)
{
    Q_UNUSED(option);
...
bool ModerationMessageDelegate::mouseEvent(QEvent *event, const QStyleOptionViewItem &option, const QModelIndex &index)
{
...
bool ModerationMessageDelegate::maybeStartDrag(QMouseEvent *event, const QStyleOptionViewItem &option, const QModelIndex &index)
{
    const Layout layout = doLayout(option, index);
...
bool ModerationMessageDelegate::hasSelection() const
{
    return mTextSelectionImpl->textSelection()->hasSelection();
}

#include "moc_moderationmessagedelegate.cpp"
