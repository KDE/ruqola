...
class LIBRUQOLAWIDGETS_TESTS_EXPORT ModerationMessageDelegate : public MessageListDelegateBase
{
    Q_OBJECT
public:
...
private:
    ...
    [[nodiscard]] ModerationMessageDelegate::Layout doLayout(const QStyleOptionViewItem &option, const QModelIndex &index) const;
