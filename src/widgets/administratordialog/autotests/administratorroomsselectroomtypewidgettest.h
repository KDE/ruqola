...
#ifndef ADMINISTRATORROOMSSELECTROOMTYPEWIDGETTEST_H
#define ADMINISTRATORROOMSSELECTROOMTYPEWIDGETTEST_H
...
#endif // ADMINISTRATORROOMSSELECTROOMTYPEWIDGETTEST_H
