...
/** Sends a message, stars (favorites) it, and verifies the starred state arrives. */
class LIBRUQOLAWIDGETS_TESTS_EXPORT FavoriteMessageCheck : public AbstractServerCheck
{
    Q_OBJECT
public:
