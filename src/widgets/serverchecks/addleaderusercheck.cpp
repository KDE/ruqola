...
#include "addleaderusercheck.h"

#include <KLocalizedString>

QString AddLeaderUserCheck::name() const
{
    return i18n("Add Leader User");
}

void AddLeaderUserCheck::doStart()
{
    if (!mAccount) {
                ...
                changeChannelLeaderUser(
                    ...
                    [this, user](bool ok, const QString &error) {
                        if (ok) {
                            ...
                            reportFailed(i18n("Could not add leader \"%1\": %2", user, error));
                        }
                    },
                    true);
            });
...
#include "moc_addleaderusercheck.cpp"
