    ...
    , mReactions(new QCheckBox(i18nc("@option:check", "Reactions"), this))
{
    ...
    addCheckBox(mEnabled, QStringLiteral("SlackBridge_Enabled"));
    ...
    addCheckBox(mFileUpload, QStringLiteral("SlackBridge_FileUpload_Enabled"));
    ...
    addCheckBox(mSlackBridgeOutEnabled, QStringLiteral("SlackBridge_Out_Enabled"));
    ...
    addCheckBox(mSlackBridgeOutAll, QStringLiteral("SlackBridge_Out_All"));
    ...
    addCheckBox(mReactions, QStringLiteral("SlackBridge_Reactions_Enabled"));
}
