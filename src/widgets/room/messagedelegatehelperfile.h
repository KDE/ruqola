...
#ifndef MESSAGEDELEGATEHELPERFILE_H
#define MESSAGEDELEGATEHELPERFILE_H
...
{
public:
    void draw(QPainter *painter, const QRect &rect, const QModelIndex &index, const QStyleOptionViewItem &option) const override;
