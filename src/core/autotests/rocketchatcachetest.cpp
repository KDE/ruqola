...
void RocketChatCacheTest::shouldGenerateFileCachePath_data()
{
    ...
    QTest::addRow("empty") << QUrl() << 1 << u"/home/laurent/.qttest/cache/rocketchatcachetest/foo/MainCache/"_s;

    QTest::addRow("test1") << QUrl(u"/file-upload/68f639d781d20ee79ad37dc0/YSKEtW.png"_s) << 1
                           << u"/home/laurent/.qttest/cache/rocketchatcachetest/foo/MainCache//file-upload/68f639d781d20ee79ad37dc0/YSKEtW.png"_s;

    QTest::addRow("test2")
        << QUrl(u"https://www.kde.com/apps/files_sharing/preview/ooj3432?file=/2020-11-04T10_05_58.500044.jpg&x=4518&y=2542&a=true"_s) << 1
        << u"/home/laurent/.qttest/cache/rocketchatcachetest/foo/MainCache/www.kde.com//apps/files_sharing/preview/ooj3432_2020-11-04T10_05_58.500044.jpg"_s;
}
