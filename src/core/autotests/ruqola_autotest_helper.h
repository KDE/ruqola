...
{
    const QString refFile = QLatin1StringView(RUQOLA_DATA_DIR) + repo + name + u".ref"_s;
    const QString generatedFile = QLatin1StringView(RUQOLA_BINARY_DATA_DIR) + repo + name + u"-generated.ref"_s;
