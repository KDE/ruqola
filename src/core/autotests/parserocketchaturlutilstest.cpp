...
void ParseRocketChatUrlUtilsTest::shouldParseUrl_data()
{
    ...
    QTest::addRow("gorocketchat-1")
        << u"https://go.rocket.chat/room?rid=NCrToCewka5MgMcDM&mid=Xope7b8WYWz82yHaq&host=www.kde.org&path=channel%2Ffoo%3Fmsg%3DXope7b8WYWz82yHaq"_s
        << ParseRocketChatUrlUtils::UrlType::Message << u"Xope7b8WYWz82yHaq"_s << u"NCrToCewka5MgMcDM"_s << u"www.kde.org"_s
        << u"channel/foo?msg=Xope7b8WYWz82yHaq"_s << ParseRocketChatUrlUtils::ChannelType::Channel << ParseRocketChatUrlUtils::RoomIdType::RoomId;

    QTest::addRow("gorocketchat-2")
        << u"https://go.rocket.chat/"
           u"room?rid=XQv6u7Kyb4pfDhS4wuKK39zoewTkdacidH&mid=Bo8pcAH86LxiYzu98&host=www.kde.org&path=direct%2FXQv6u7Kyb4pfDhS4wuKK39zoewTkdacidH%3Fmsg%"
           u"3DBo8pcAH86LxiYzu98"_s
        << ParseRocketChatUrlUtils::UrlType::Message << u"Bo8pcAH86LxiYzu98"_s << u"XQv6u7Kyb4pfDhS4wuKK39zoewTkdacidH"_s << u"www.kde.org"_s
    ...
    QTest::addRow("rocketchatscheme-1")
        << u"rocketchat://"
           u"room?rid=XQv6u7Kyb4pfDhS4wuKK39zoewTkdacidH&mid=Bo8pcAH86LxiYzu98&host=www.kde.org&path=direct%2FXQv6u7Kyb4pfDhS4wuKK39zoewTkdacidH%3Fmsg%"
           u"3DBo8pcAH86LxiYzu98"_s
        << ParseRocketChatUrlUtils::UrlType::Message << u"Bo8pcAH86LxiYzu98"_s << u"XQv6u7Kyb4pfDhS4wuKK39zoewTkdacidH"_s << u"www.kde.org"_s
