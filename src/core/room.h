...
public:
    ...
    */
    ...
    Q_REQUIRED_RESULT bool notificationsDisabled() const;
    void setNotificationsDisabled(bool disable);
...
Q_SIGNALS:
    ...
    void notificationsDisabledChanged();
...
private:
    ...
    bool mNotificationsDisabled = false;
